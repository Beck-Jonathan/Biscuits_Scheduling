...
public class AllPaletteServletTest {
  private static final String PAGE="WEB-INF/schedule_app/All_Palette.jsp";
  AllPaletteServlet servlet;
  ...
  /**
   <p> Test that a logged in user is able to retrieve all of the Palette objects. </p>
   */
  @Test
  public void testLoggedInUserWithNoIDGetsNoPalettes() throws ServletException, IOException{
    User user = new User();
    List<String> roles = new ArrayList<>();
    roles.add("User");
    user.setRoles(roles);
    ...
    request.setSession(session);
    servlet.doGet(request,response);
    List<Palette> palettes = (List<Palette>) request.getAttribute("Palettes");
  ...
  /**
   <p> Test that getting all Palette can filter. </p>
   */
  @Test
  public void testLoggedInUserCanFilterPalettesByUser_ID() throws ServletException, IOException{
    User user = new User();
    List<String> roles = new ArrayList<>();
    roles.add("User");
    user.setRoles(roles);
